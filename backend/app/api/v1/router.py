...
from app.api.v1.admin import restaurants as admin_restaurants, orders as admin_orders, payments as admin_payments, delivery_partners as admin_delivery_partners
